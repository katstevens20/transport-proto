...
namespace Kat\TransportProto\message;
...
use Kat\TransportProto\message\encoding\base128varint;
use Kat\TransportProto\message\type\PBScalar;
use Kat\TransportProto\message\type\PBEnum;
use Kat\TransportProto\message\type\PBBytes;
use Kat\TransportProto\message\type\PBString;
use Kat\TransportProto\message\type\PBInt;
use Kat\TransportProto\message\type\PB32Bit;
use Kat\TransportProto\message\type\PB64Bit;
use Kat\TransportProto\message\type\PBBool;
use Kat\TransportProto\message\type\PBSignedInt;
use Kat\TransportProto\message\reader\PBInputReader;
use Kat\TransportProto\message\reader\PBInputStringReader;
use Exception;
...
abstract class PBMessage
{
     ...
     * Internal function
     */
    private function _ParseFromArray($length=99_999_999)
    {
        ...
        while ($this->reader->get_pointer() - $_begin < $length)
        {
            ...
            if (is_array($this->values[$messtypes['field']]))
            {
                ...
                $index = (is_countable($this->values[$messtypes['field']]) ? count($this->values[$messtypes['field']]) : 0) - 1;
    ...
    {
        return is_countable($this->values[$index]) ? count($this->values[$index]) : 0;
    }
