<?php
namespace Kat\TransportProto\message\encoding;
...
class base128varint
{
    ...
    {
        $string = decbin( (string) $number );
        
//        echo "value : ".$number." converted : ".$string."<br/>";
    ...
    public function get_value($string)
    {
        ...
        {
//        	echo "sous valeur : ".substr($string, $i, 7)." ".bindec(substr($string, $i, 7))."<br/>";
